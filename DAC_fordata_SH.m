function [results] = DAC_fordata_SH(price_cap, price_data, SH_data, X, k, h, parameters)
    ...
    results = cell(numel(price_data),12);
    ...
    for t = 1:numel(price_data)
        ...
        results(t, :) = {u, v, SHB, k, z, price_data(t),SH_data(t), h, X, a, d, profit};
    end
end